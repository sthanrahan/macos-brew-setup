...
# Mac App Store command-line interface (safe to keep)
brew "mas"
...
# Python (your system uses only 3.14)
brew "python@3.14"
...
# ======= FFmpeg (zvbi-free build, matches your system) =======
...
# ========== MAS (COMMENTED OUT DUE TO MACOS LIMITATIONS) ==========
